...
// LOGIN USER
export const login =
    (email, password, setIsLoading, setErrors) => (dispatch) => {
        // getState not needed since we aren't including a token with the request
        setIsLoading(true);
...
export const register =
    (email, password, username, first, last, setIsLoading, setErrors) =>
    (dispatch) => {
        setIsLoading(true);
