...
export const getCurrentUserSpotifyProfile = () => (dispatch, getState) => {
  axiosInstance
    .get("spotify/get-current-user-spotify-profile", reduxTokenConfig(getState))
    .then((res) => {
      dispatch({
...
export const getSpotifyAuthStatus = () => (dispatch, getState) => {
  axiosInstance
    .get("/spotify/is-spotify-authenticated", reduxTokenConfig(getState))
    .then((res) => {
      dispatch({
...
export const getSpotifyAuthURL = () => (dispatch, getState) => {
  axiosInstance
    .get("/spotify/get-auth-url", reduxTokenConfig(getState))
    .then((res) => {
      dispatch({
