...
function RegisterFunctional(props) {
            ...
            <div className={'col-md-6 m-auto'}>
                <div className={'card card-body mt-5'}>
                    ...
                    <form method={'post'} onSubmit={handleSubmit}>
                        ...
                        name={'re_password'} errorMessage={errors.msg.re_password}/>
...
export default connect(mapStateToProps, {register})(RegisterFunctional)