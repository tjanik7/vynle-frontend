...
function Settings(props) {
    ...
    const spotifyAccountInfo = (
        <div className={'py-3'}>
            <span><strong>Username:</strong> {userSpotifyProfile.id}</span><br/>
            <span><strong>Email:</strong> {userSpotifyProfile.email}</span>
        </div>
    )

    const spotifyError = (
        <>
            <h6>We ran into an error when fetching your linked Spotify account.</h6>
