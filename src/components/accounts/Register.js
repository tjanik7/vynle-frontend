      ...
      <div className={"col-md-6 m-auto"}>
        <div className={"card card-body mt-5"}>
          ...
          <form method={"post"} onSubmit={handleSubmit}>
            ...
            {/*username field*/}
            <AuthField
              fieldHasError={fieldHasError["username"]}
              label={"Username"}
              name={"username"}
            ...
            {/*first name field*/}
            <AuthField
              fieldHasError={fieldHasError["first"]}
              label={"First Name"}
              name={"first"}
            ...
            {/*last name field*/}
            <AuthField
              fieldHasError={fieldHasError["last"]}
              label={"Last Name"}
              name={"last"}
            ...
            {/*re_password field*/}
            <AuthField
              fieldHasError={fieldHasError["re_password"]}
              label={"Confirm Password"}
              name={"re_password"}
              fieldType={"password"}
              errorMessage={errors.msg.re_password}
            />
